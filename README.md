...
| `seriesResolveTitle`        | Resolve titles of series from stream                                                                                                                                                                                                                                                                | &#x2713; | `false`                                       |
...
| `generatorThreads`          | Number of threads for the generator phase. The lesser the value, the longer the generation will take.                                                                                                                                                                                               | &#x2713; | `10`                                          |
...
|--------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|----------|--------------------------|------------------------------|
| `geminiAiKey`            | Google GEMINI AI key(s). Array of string or comma\|semicolon\|space-separated string when passed as argument.<br/>Rotate through keys if multiple. |          |                          |                              |
| `geminiAiModel`          | Google GEMINI AI model (should be supported by your key).                                                                                          | &#x2713; | `gemini-3-flash-preview` |                              |
| `outputDir`              | Output directory of generated M3U files                                                                                                            | &#x2713; | `.`                      |                              |
